        ...
        return Vue.component("home-component", {
            ...
            created(){
                this.loadData().then(response => {
                    ...
                    console.log("social_feed", social_feed)
            ...
            computed: {
                ...
                featuredItems() {
                    ...
                    _.forEach(this.processedPromos, function(value, key) {
                        ...
                        if (today >= showOnWebDate) {
                            if (_.includes(value.image_url, 'missing')) {
                                value.image_url = "//codecloud.cdn.speedyrails.net/sites/5d7121e26e6f641906020000/image/png/1539375270000/pc_promo_default.png";
                            }
                    ...
                    _.forEach(this.processedEvents, function(value, key) {
                        ...
                        if (today >= showOnWebDate) {
                            if (_.includes(value.image_url, 'missing')) {
                                value.image_url = "//codecloud.cdn.speedyrails.net/sites/5d7121e26e6f641906020000/image/png/1539375346000/pc_event_default.png";
                            }
