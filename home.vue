            ...
            computed: {
                ...
                featuredItems() {
                    ...
                    _.forEach(this.processedPromos, function(value, key) {
                        ...
                        if (today >= showOnWebDate) {
                            if (_.includes(value.image_url, 'missing')) {
                                value.image_url = "//codecloud.cdn.speedyrails.net/sites/5ddb449e6e6f6416db040000/image/png/1539375270000/pc_promo_default.png";
                            }
                    ...
                    _.forEach(this.processedEvents, function(value, key) {
                        ...
                        if (today >= showOnWebDate) {
                            if (_.includes(value.image_url, 'missing')) {
                                value.image_url = "//codecloud.cdn.speedyrails.net/sites/5ddb449e6e6f6416db040000/image/png/1539375346000/pc_event_default.png";
                            }
