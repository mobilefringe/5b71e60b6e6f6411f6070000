...
<div class="banner_image" v-bind:style="{ backgroundImage: 'url(//codecloud.cdn.speedyrails.net/sites/5b71e60b6e6f6411f6070000/image/jpeg/1542212602000/PC_Tree818_1925x470_1.jpg)' }"></div>
        ...
        return Vue.component("home-component", {
                    ...
                    _.forEach(this.processedPromos, function(value, key) {
                        ...
                        if (today >= showOnWebDate) {
                            if (_.includes(value.image_url, 'missing')) {
                                value.image_url = "//codecloud.cdn.speedyrails.net/sites/5b71e60b6e6f6411f6070000/image/png/1539375270000/pc_promo_default.png";
                            }
            ...
            methods: {
                loadData: async function() {
                    try {
                        let results = await Promise.all([this.$store.dispatch("getData", "banners"), this.$store.dispatch("getData","promotions"), this.$store.dispatch("getData", "events"), this.$store.dispatch('LOAD_PAGE_DATA', {url: "https://pacificcommons.mallmaverick.com/api/v3/pacificcommons/social.json"})]);
                        return results;
                    } catch(e) {
