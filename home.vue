        ...
        return Vue.component("home-component", {
            ...
            methods: {
                loadData: async function() {
                    try {
                        let results = await Promise.all([this.$store.dispatch("getData", "banners"), this.$store.dispatch("getData","promotions"), this.$store.dispatch("getData", "events"), this.$store.dispatch('LOAD_PAGE_DATA', {url: "https://pacificcommons.mallmaverick.com/api/v4/pacificcommons/social.json"})]);
                        return results;
                    } catch(e) {
