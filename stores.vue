                                    ...
                                    <div class="store_logo_container">
                                        <router-link :to="'/stores/'+ store.slug">
                                            <div v-if="!store.no_store_logo">
                                                <img class="transparent_logo" src="//codecloud.cdn.speedyrails.net/sites/5d7121e26e6f641906020000/image/png/1536094188000/default_background.png">
                                                <img  class="store_img" :src="store.store_front_url_abs" alt="">
                                            </div>
                                            
                                            <div v-else class="no_logo_container">
                                                <img class="transparent_logo" src="//codecloud.cdn.speedyrails.net/sites/5d7121e26e6f641906020000/image/png/1536094188000/default_background.png" alt="">
