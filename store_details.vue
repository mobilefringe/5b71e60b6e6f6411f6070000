                ...
                currentStore: function () {
                    ...
                    _.forEach(this.currentStore.promotions, function(value, key) {
                        ...
                        if (_.includes(current_promo.image_url, 'missing')) {
                            current_promo.image_url = "//codecloud.cdn.speedyrails.net/sites/5ddb449e6e6f6416db040000/image/png/1539375270000/pc_promo_default.png";
                        }
                    ...
                    _.forEach(this.currentStore.events, function(value, key) {
                        ...
                        if (_.includes(current_event.image_url, 'missing')) {
                            current_event.image_url = "//codecloud.cdn.speedyrails.net/sites/5ddb449e6e6f6416db040000/image/png/1539375346000/pc_event_default.png";
                        }
