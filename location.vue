    ...
    <div> <!-- for some reason if you do not put an outer container div this component template will not render -->
        ...
        <transition name="fade">
            <div v-if="dataLoaded" v-cloak>
                <div class="inside_page_header" v-bind:style="{ background: 'linear-gradient(0deg, rgba(0,0,0,0.2), rgba(0,0,0,0.2)), url(' + pageBanner.image_url + ') center center rgb(0, 115, 141)' }">
                ...
                <div class="main_container">
                    <div class="location_map">
                        <iframe :src="propertyAddress()" aria-label="Pacific Common's location displayed in Google Maps." width="100%" height="490" frameborder="0" style="border:0" allowfullscreen></iframe>
                    </div>
                </div>
                <div class="main_container">
                    <div class="row">
		...
		return Vue.component("location-component", {
            ...
            methods: {
                loadData: async function () {
                    ...
                    try {
                        let results = await Promise.all([this.$store.dispatch('LOAD_PAGE_DATA', {url: this.property.mm_host + "/pages/pacificcommons-location.json"})]);
                        return results;
                    } catch (e) {
