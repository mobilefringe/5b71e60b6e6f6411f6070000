		...
		return Vue.component("location-component", {
            ...
            created() {
                this.loadData().then(response => {
                    ...
                    this.leasingInfo = response[0].data.subpages
            ...
            methods: {
                loadData: async function () {
                    ...
                    try {
                        let results = await Promise.all([this.$store.dispatch('LOAD_PAGE_DATA', {url: this.property.mm_host + "/pages/pacificcommons-pop-up-specialty-leasing.json"})]);
                        return results;
                    } catch (e) {
