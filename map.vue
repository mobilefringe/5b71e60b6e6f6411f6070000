            ...
            <div v-if="dataLoaded" v-cloak>
                ...
                <div class="main_container">
                    ...
                    <div class="row margin_60">
                        ...
                        <div class="col-md-9">
                            <mapplic-map ref="mapplic_ref" :svgWidth="2500" :svgHeight="2300" :height="664" :minimap= "false" :deeplinking="false" :sidebar="false" :hovertip="true" :maxscale= "5" :storelist="allStores" :floorlist="floorList" tooltiplabel="View Store Details"></mapplic-map>
                        </div>
                    </div>
                </div>
            </div>
