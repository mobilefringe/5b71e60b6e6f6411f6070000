                    ...
                    _.forEach(events, function (value, key) {
                        ...
                        if (today >= showOnWebDate) {
                            ...
                            if (value.store != null && value.store != undefined && _.includes(value.store.image_url, 'missing')) {
                                value.store.image_url = "//codecloud.cdn.speedyrails.net/sites/5ddb449e6e6f6416db040000/image/png/1539375346000/pc_event_default.png";
                            }
                            ...
                            value.description_short = _.truncate(value.description, { 'length': 200, 'separator': ' ' });
