    ...
    const vm = new Vue({
        ...
        data: function () {
            return {
                ...
                social_media: [
                    {
                        name: "Facebook",
                        url: "https://www.facebook.com/ShopPacificCommons",
                        iconClass: "fab fa-facebook"
                    },
                    {
                        name: "Instagram",
                        url: "https://www.instagram.com/shoppacificcommons",
        ...
        methods: {
            loadData: async function() {
                try{
                    await this.$store.dispatch('initializeApi', { site: "pacificcommons", version: "v4" });
